...
import c1.big.data.mapreduce.C1Mapper_1st;
import c1.big.data.mapreduce.C1Reducer_1st;
import c1.big.data.util.CSKV;
import c1.big.data.util.PosUtils;

public class C1Count_1st {
	public static String InputPath = "posdata";
	public static String OutputPath = "out/C1Count1st";
	public static int TaskNum = 8;

	public static void main(String[] args) throws IOException,
			InterruptedException, ClassNotFoundException {
		Job job = new Job(new Configuration());
		job.setJarByClass(C1Count_1st.class);
		job.setMapperClass(C1Mapper_1st.class);
		job.setReducerClass(C1Reducer_1st.class);
