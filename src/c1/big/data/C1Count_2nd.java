...
import c1.big.data.mapreduce.C1Mapper_2nd;
import c1.big.data.mapreduce.C1Reducer_2nd;
import c1.big.data.util.CSKV;
import c1.big.data.util.PosUtils;

public class C1Count_2nd {
	public static String InputPath = "out/C1Count1st";
	public static String OutputPath = "out/C1Count2nd";
	public static int TaskNum = 8;

	public static void main(String[] args) throws IOException,
		InterruptedException, ClassNotFoundException {
		Job job = new Job(new Configuration());
		job.setJarByClass(C1Count_2nd.class);
		job.setMapperClass(C1Mapper_2nd.class);
		job.setReducerClass(C1Reducer_2nd.class);
